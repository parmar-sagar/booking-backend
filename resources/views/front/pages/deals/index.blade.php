      ...
      <main class="l-main">
        <section class="section">
          <div class="container">
                        ...
                        <div class="card__headline-price-wrapper  col-8">
                          ...
                          <div class="row great_dealsbtn">
                            <div class="col-6 col-lg-6">
                              <div class="card__headline-price-main card__headline-price-main--large bg-blurple"> £1460 </div>
                            </div>
                            <div class="col-6 col-lg-6">
                              <a class="btn btn--purple" href="{{url('view-detail/'.$deals['id'])}}" title="View now"> Book Now </a>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            {{-- <p class="text-center">
								<a class=" btn btn--black " href="/book-a-backpacking-tour?deals_only=1"
                    title="View All Deals"> View All Deals </a>
							</p> --}}
          </div>
        </section>
        <section class=" section mt-20em bg-white-top-jaw      ">
          {{-- <div class="section__wrapper">
							...
							<div class="headline-wave headline-wave--center">
								<h2 class="headline-3">More Tours</h2>
							...
							<div class="row row--g-top row--g-20">
								<article class="col-lg-6 col-xxl-4 animation-delay-0 animated fadeInUp active">
									<a
                      ...
                      data-was-processed="true">
											<div class="card__header">
												<div class="card__header-col">
													<span class="chip chip--orange mt-0em">lorem</span>
													<span
                            class="chip chip--purple">Group Tour</span>
												</div>
												<div class="card__header-col">
													<div class="card__header-price-box">
														<div class="card__header-price bg-orange"> €2330 
															<span
										...
										<div class="card__content card__content--stretch">
											...
											<ul class="list-tour-info list-tour-info--two-cols">
												<li class="list-tour-info__item">
													<svg width="36px" height="36px" class="fill-orange" aria-hidden="true"
                            aria-focusable="false">
														<use
															xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/icons.svg#icon-calendar-range">
														</use>
													</svg>
                            ...
                            aria-focusable="false">
														<use
															xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/icons.svg#icon-baby-face-outline">
														</use>
													</svg>
													<div class="list-tour-info__item-desc">
														<b>Avg. Age</b>
                            ...
                            aria-focusable="false">
														<use
															xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/icons.svg#icon-rowing">
														</use>
													</svg>
													<div class="list-tour-info__item-desc">
														<b>No. Of Activities</b>
														<span>30+</span>
													</div>
												</li>
												<li class="list-tour-info__item">
                            ...
                            aria-focusable="false">
														<use
															xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/icons.svg#icon-silverware-fork-knife">
														</use>
													</svg>
													<div class="list-tour-info__item-desc">
														<b>No. Of Meals</b>
                            ...
                            aria-focusable="false">
														<use
															xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/icons.svg#icon-account-multiple">
														</use>
													</svg>
													<div class="list-tour-info__item-desc">
														<b>Avg. Group Size</b>
                            ...
                            aria-focusable="false">
														<use
															xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/icons.svg#icon-star">
														</use>
													</svg>
													<div class="list-tour-info__item-desc">
														<b>Operator</b>
														<span>Backpacking Tours</span>
													</div>
												</li>
												<li class="list-tour-info__item">
													<svg width="36px" height="36px" class="fill-orange" aria-hidden="true"
                            aria-focusable="false">
														<use
															xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/icons.svg#icon-map">
														</use>
													</svg>
													<div class="list-tour-info__item-desc">
														<b>Starting Point</b>
                            ...
                            aria-focusable="false">
											...
											<div class="card__footer card__footer--center card__footer--block-mobile card__footer--to-bottom">
												<span
                          class="btn btn--small btn--purple">View Tour</span>
											</div>
										</div>
									</a>
								</article>
								<article class="col-lg-6 col-xxl-4 animation-delay-1 animated fadeInUp active">
									<a
                    class="card card--flex card--shadow-blurple" href="/bali-backpacking-tour" title="Backpacking Bali">
                      ...
                      data-was-processed="true">
											<div class="card__header">
												<div class="card__header-col">
													<span class="chip chip--blurple mt-0em">lorem</span>
													<span
                            class="chip chip--purple">Group Tour</span>
												</div>
												<div class="card__header-col">
													<div class="card__header-price-box">
														<div class="card__header-price bg-blurple"> €1685 
															<span
                                class="card__header-price-label bg-blurpleDark text-upper">from</span>
										...
										<div class="card__content card__content--stretch">
											...
											<ul class="list-tour-info list-tour-info--two-cols">
												<li class="list-tour-info__item">
													<svg width="36px" height="36px" class="fill-blurple" aria-hidden="true"
                            aria-focusable="false">
														<use
															xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/icons.svg#icon-calendar-range">
														</use>
                          ...
                          class="btn btn--small btn--purple">View Tour</span>
								...
								<article class="col-lg-6 col-xxl-4 animation-delay-2 animated fadeInUp active">
									<a
                    class="card card--flex card--shadow-blue" href="/vietnam-backpacking-tour" title="Backpacking Vietnam">
                      ...
                      data-was-processed="true">
											<div class="card__header">
												<div class="card__header-col">
													<span class="chip chip--blue mt-0em">Lorem</span>
													<span
                            class="chip chip--purple">Group Tour</span>
												</div>
												<div class="card__header-col">
													<div class="card__header-price-box">
														<div class="card__header-price bg-blue"> €2545 
															<span
                                class="card__header-price-label bg-blueDark text-upper">from</span>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="card__content card__content--stretch">
											...
											<ul class="list-tour-info list-tour-info--two-cols">
												<li class="list-tour-info__item">
													<svg width="36px" height="36px" class="fill-blue" aria-hidden="true"
                            aria-focusable="false">
														<use
															xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/images/icons.svg#icon-calendar-range">
														</use>
