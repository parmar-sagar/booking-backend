    ...
    <div class="container payment" style="padding:30px auto;">
        <div class="row" style="margin:100px auto;">
          <div class="col-75">
           ...
           -->
                    <!-- <div class="row"><div class="col-50"><label for="state">State</label><input type="text" id="state" name="state" placeholder="NY"></div><div class="col-50"><label for="zip">Zip</label><input type="text" id="zip" name="zip" placeholder="10001"></div></div> -->
                  </div>
                  <div class="col-50">
                    <h3>Payment</h3>
