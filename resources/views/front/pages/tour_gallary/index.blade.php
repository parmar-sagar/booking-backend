                ...
                <div class="tour-gallery__images js-gallery-images" data-gallery-day="1" data-gallery-category="activities">
                  ...
                  <ul class="tour-gallery__image-list" data-id="galleryList">
                    ...
                    <li class="tour-gallery__image-list-item"> 
                        <button type="button" class="js-thumb-button tour-gallery__image-list-button {{ $loop->first ? 'active' : '' }}" onclick="App.updatePreview(this, 'activities', 1);" data-description="" data-popup-img-url="{{ asset('admin/uploads/gallry_images/'.$images) }}">
                            <img class="tour-gallery__image-list-thumb rotate-left lazy loaded" data-src="{{ asset('admin/uploads/gallry_images/'.$images) }}" alt="" src="{{ asset('admin/uploads/gallry_images/'.$images) }}" data-was-processed="true"> 
                        </button> 
                    </li>
                    @endforeach
                  </ul>
