                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="number" id="disc" min="0" class="form-control" name="disc" value="@if(isset($objData)){{ $objData->disc }}@endif">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="with_pickup" name="pickup_status" class="form-check-input" value="1" @if(isset($objData) && $objData->pickup_status == 1) checked @endif>
                                    <label class="form-check-label" for="with_pickup">With Pickup</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="without_pickup" name="pickup_status" class="form-check-input" value="0" @if(isset($objData) && $objData->pickup_status == 0) checked @endif>
                                    <label class="form-check-label" for="without_pickup">Without Pickup</label>
                                </div>
                                <div class="form-check form-check-inline">
