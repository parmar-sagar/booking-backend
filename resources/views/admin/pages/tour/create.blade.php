                ...
                <div class="row">
                    ...
                    <!-- <div class="col-lg-6">
                        <div class="mb-3">
                            <div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="fixed-voucher-active" name="voucher_status" class="form-check-input" value="1" @if(isset($objData) && $objData->voucher_status == 1) checked @endif>
                                    <label class="form-check-label" for="fixed-voucher-active">Fixed Dated voucher</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="open-voucher-active" name="voucher_status" class="form-check-input" value="0" @if(isset($objData) && $objData->voucher_status == 0) checked @endif>
                                    <label class="form-check-label" for="open-voucher-active">Open Dated Voucher</label>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function(){
    let voucherGenerate=document.querySelectorAll('.voucherGenrate')
    $('#voucher-active').on('click',function(){
        voucherGenerate.forEach(function(val){
