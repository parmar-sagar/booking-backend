            ...
            <form id="submit-form" action="{{ $action }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                     ...
                     <div class="col-lg-6">
                        <div class="mb-3">
                            <label for="min_age" class="form-label">Availability</label>
                            <input type="text" id="availability" class="form-control" name="availability" value="@if(isset($objData->availability) && $objData->availability){{ $objData->availability }}@endif" required>
                        </div>
                    </div>
                     <div class="col-lg-6">
                        <div class="mb-3">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="sequence" class="form-control" name="sequence" value="@if(isset($objData) && $objData->sequence){{ $objData->sequence }}@endif">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
