...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('vehicles', function (Blueprint $table) {
            ...
            $table->string('time_ids', 100)->index('idx_time_ids');
            $table->string('includes_ids', 100)->index('idx_includes_ids');
            $table->string('warning_ids', 100)->index('idx_warning_ids');
            $table->string('highlight_ids', 100)->index('idx_highlight_ids');
